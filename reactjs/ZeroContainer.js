...
export class ZeroContainer extends Component {
    ...
    render() {
        let type = typeof this.props.placeholder;
        let isEmptyValue;
        if (type === "string") {
            isEmptyValue = <h1 className={this.props.useContainer ? "zero-container-main use-container" : "zero-container-main"} style={this.props.useContainer ? { lineHeight: '200px' } : null}>{this.props.placeholder}</h1>;
        } else {
