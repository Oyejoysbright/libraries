...
function AdvanceView({children, color, title, changeView, subtitle = [], disabled}) {
    ...
    return (
        <div className="jpc advance-view">
            {/* <div style={{height: '70vh', zIndex: 2, width: '70vw', position: 'fixed', top: '0px', right: '0px', backgroundColor: 'rebeccapurple'}}>HERE</div> */}
...
export function TitlePartner({children, style, className}) {
    return(
